...
IQTHONPC = gvarstatus("ALIVE_PIC") or "https://graph.org/file/8552761863e56ffb58f23.mp4"
...
IQPIC = gvarstatus("ALIVE_PIC") or "https://graph.org/file/8552761863e56ffb58f23.mp4"
...
async def iq(iqthonevent):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "𝗐𝖾𝗅𝖼𝗈𝗆𝖾 Jethon Kimo 𓃠"
    IQTHON_IMG = gvarstatus("ALIVE_PIC") or "https://graph.org/file/8552761863e56ffb58f23.mp4"
...
async def amireallyalive(event):
    ...
    IQTHON_ALIVE_TEXT = "❬ جيثون كيمو - Jethon Kimo ، 🕸  ❭ :"
...
async def _(event):
    ...
    OUTPUT = (f"🝳︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس جيثون @D8_8Q :**\n\n{o}")
...
https://t.me/DevKiMo/4718
• لكيفيه حذف الفار اضغط هنا ↶
https://t.me/Teamtelethon/51

قناة الكلايش  : @@DevKiMo
قناه شروحات الاوامر  : @D8_8Q
قناه المتغيرات او الفارات : @D8_8Q""")
    ...
    if vname in vlist:
        ...
        if cmd == "اضف":
            if not vinfo and vname == "ALIVE_TEMPLATE":
                return await edit_delete(event, f"**🝳︙  📑 يرجى متابع قناه الفارات تجدها هنا : @DevKiMo")
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inlineiqthon(iqthon):
        ...
        if query.startswith("تنصيب") and iqthon.query.user_id == bot.uid:
            buttons = [[Button.url("1- شرح التنصيب", "https://youtu.be/44tYK_yV02Q"), Button.url("2- استخراج ايبيات", "https://my.telegram.org/"),],[Button.url("3- ستخراج تيرمكس", "https://replit.com/@telethon-Arab/generatestringsession#start.sh"), Button.url("4- بوت فاذر", "http://t.me/BotFather"),],[Button.url("5- رابط التنصيب", "https://dashboard.heroku.com/new?template=https://github.com/telethon-Arab/telethohelp"),],[Button.url("المطـور 👨🏼‍💻", "https://t.me/T_5_C"),]]
...
( .ايقاف اسم وقتي )
———————×———————
 🝳︙ يوجد شرح مفصل عن الامر هنا : https://t.me/DevKiMo/4484
""")
...
https://t.me/Teamtelethon/51
———————×——————— 
قناه المتغيرات او الفارات : @DevKiMo
شرح الأوامر : ( @DevKiMo ) .
قناه السورس : ( @D8_8Q ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
الشرح :   يضيفلك جميع الاعضاء الي برابط الكروب يضيفهم بكروبك 
 ———————×———————
يوجد شرح بتفصيل هنا : https://t.me/DevKiMo/4483
شرح الأوامر : ( @DevKiMo ) .
قناه السورس : ( @D8_8Q ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
———————×———————
يوجد شرح مفصل للتكرار هنا : https://t.me/DevKiMo/4704 
قناه السورس : ( @D8_8Q ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
✐ :  يعطيك رموز للزخرفه2 
———————×———————
يوجد شرح مفصل عن اوامر زخرفه هنا : https://t.me/DevKiMo/4705
""")
...
———————×———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/DevKiMo/4721  ⦒
""")
...
———————×———————
  ⦑   شرح اوامر الملصقات هنا  :  https://t.me/DevKiMo/4720  ⦒
""")
