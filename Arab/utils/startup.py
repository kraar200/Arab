...
async def startupmessage():
    try:
        if BOTLOG:
            Config.CATUBLOGO = await iqthon.tgbot.send_file(BOTLOG_CHATID, "https://graph.org/file/8552761863e56ffb58f23.mp4", caption="🝳 ⦙ تـمّ  اعـادة تشـغيل\n جيثون كيمو ✓  :  [ 7.7 ] .\n\n🝳 ⦙ للحصول على اوامر السورس\n أرسـل : (  `.اوامري`  ) \n\n🝳 ⦙ لمـعرفة كيفية تغير بعض كلايش\n او صور السـورس  أرسـل  :\n (  `.مساعده`  )\n\n🝳 ⦙ القناة الرسمية تليثون العرب : @DevKiMo\n🝳 ⦙ فارات سورس تليثون  :@DevKiMo \n🝳 ⦙ كلايش تليثون :  @d8_8q\n 🝳 ⦙التحديثات والاضافات :  @DevKiMo\n",                buttons=[(Button.url("مطور جيثون الرسمي", "https://t.me/T_5_C",)],            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def verifyLoggerGroup():
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        _, groupid = await create_supergroup(            "تخزين جيثون الخاص", iqthon, Config.TG_BOT_USERNAME, descript    , iqphoto2  )
